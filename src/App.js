...
const TWITTER_HANDLE = "DK75568636";
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const OPENSEA_LINK = "";
const TOTAL_MINT_COUNT = 50;

// コトントラクトアドレスをCONTRACT_ADDRESS変数に格納
const CONTRACT_ADDRESS = "0x9d51D5C2dd1D26d7EF94c2fce3dbCEF2D8139672";
  ...
  return (
    <div className="App">
      <div className="container">
        ...
        <a href="https://testnets.opensea.io/collection/squarenft-nbjdf8re3l" className="RaribleUrl">Raribleでコレクションを表示</a> 
